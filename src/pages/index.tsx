    ...
    return (
        <div className="">
            ...
            <div className="h-screen ">
                <section className="relative h-screen shadow-[0px_36px_80px_30px_#000000]">
            ...
            <div className="h-full bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-gray-700 via-gray-900 to-black">
                <div className=" flex items-end justify-center overflow-hidden">
                    <div className=" text-white">
                        ...
                        <div className="max-w-[85rem] space-y-8 px-6 pb-16 pt-10 text-white">
                            <div>
                ...
                <div className={`${InterFont.className} mt-32`}>
                    <div className="space-y-4 text-center">
                        ...
                        <p className="mx-auto max-w-xl px-4 text-sm text-white">
                ...
                <div className="mb-20 h-screen">
                    <div className=" flex items-center justify-evenly px-4 max-[1200px]:flex-col-reverse">
                        ...
                        >
                            ...
                            <p className="max-w-2xl text-[#f1f1f18b] max-[390px]:text-sm">
